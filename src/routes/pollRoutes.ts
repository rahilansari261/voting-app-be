...
router.get("/", optionalAuthenticateToken, pollController.getAllPolls.bind(pollController));
router.get("/my-polls", authenticateToken, pollController.getPollsByUserId.bind(pollController));
